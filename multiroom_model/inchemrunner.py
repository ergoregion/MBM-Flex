...
class InChemPyRunner:
    ...
    def __init__(self,
        ...
        self.runner = InChemPyMain(self.filename, self.particles, self.timed_emissions, self.constrained_file,
    ...
    def run(self,
            initial_conditions: Union[InititialTxtFile, InitialPickleFile, InitialDataFrame],
            t0: int = 0,
            seconds_to_integrate: int = 86400,
            rel_humidity: float = 50.,
            M: float = 2.51e+19,) -> Any:
        """
        @brief Initialize the InChemPySettings class with simulation parameters.
        ...
        @param initial_conditions initial conditions used to start the simulation
